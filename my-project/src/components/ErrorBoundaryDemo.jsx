...
const BuggyComponent = ({ shouldThrow, errorType }) => {
  ...
  return (
    <div className="p-4 bg-green-50 border border-green-200 rounded">
      <p className="text-green-700 font-semibold">✅ Component is working fine!</p>
  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      <div className="bg-white rounded-lg shadow-lg p-6">
        <h2 className="text-2xl font-bold mb-2 text-gray-800">🛡️ Error Boundary Demo</h2>
        <p className="text-gray-600 mb-6">
          Test how error boundaries catch and handle component errors gracefully.
        </p>

        <div className="space-y-3 mb-6">
          <p className="text-sm font-semibold text-gray-700">Click a button to trigger an error:</p>
        ...
        <div className="border-t border-gray-200 pt-6">
          <h3 className="text-sm font-semibold text-gray-700 mb-3">Component Status:</h3>
        ...
        <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded">
          ...
          <ul className="text-sm text-blue-800 space-y-1 list-disc list-inside">
            <li>Without error boundaries, errors would crash the entire app</li>
            <li>The ErrorBoundary catches errors and shows a fallback UI</li>
            <li>Users can recover by clicking "Try Again" or going home</li>
            <li>In production, errors would be logged to monitoring services</li>
          </ul>
        </div>

        <div className="mt-4 text-xs text-gray-500">
          <strong>Note:</strong> Error boundaries only catch errors during rendering, lifecycle
          methods, and constructors. They don't catch errors in event handlers, async code, or
